...
namespace TangledServices.ServicePortal.API.Services
{
    ...
    public class PointOfContactService : SystemBaseService, IPointOfContactService
    {
        ...
        public PointOfContactService(IAddressService addressService, IPhoneNumberService phoneNumberService, IEmailAddressService emailAddressService, IHashingService hashingService, ISystemUsersManager systemUsersManager, IConfiguration configuration, IWebHostEnvironment webHostEnvironment) : base(configuration, webHostEnvironment)
        {
