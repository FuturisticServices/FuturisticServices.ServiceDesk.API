...
namespace TangledServices.ServicePortal.API.Services
{
    ...
    public class BillingInformationService : SystemBaseService, IBillingInformationService
    {
        ...
        public BillingInformationService(IAddressService addressService, ISystemLookupItemsService systemLookupItemService, IHashingService hashingService, ISystemUsersManager systemUsersManager, IConfiguration configuration, IWebHostEnvironment webHostEnvironment) : base(configuration, webHostEnvironment)
        {
