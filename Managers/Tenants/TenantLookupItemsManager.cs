...
namespace TangledServices.ServicePortal.API.Managers
{
    ...
    public class TenantLookupItemsManager : TenantBaseManager, ITenantLookupItemsManager
    {
        ...
        public TenantLookupItemsManager(IHttpContextAccessor httpContextAccessor, IConfiguration configuration, IWebHostEnvironment webHostEnvironment) : base("LookupItems", httpContextAccessor, configuration, webHostEnvironment)
        {
